package com.jgeb.neska_machines_l.util.registry;

import com.jgeb.neska_machines_l.registry.BlockReg;
import com.jgeb.neska_machines_l.registry.FluidReg;
import com.jgeb.neska_machines_l.registry.ItemReg;
...
public class FluidFactoryBuilder {
    ...
    public FluidFactoryBuilder(String name, FluidType.Properties typeProperties,
        ...
        this.type = FluidReg.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = FluidReg.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = FluidReg.FLUIDS.register(name + "_flowing",
        ...
        this.block = BlockReg.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = ItemReg.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
